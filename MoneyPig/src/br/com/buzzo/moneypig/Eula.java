 ...
 * application should call {@link Eula#show(android.app.Activity)} in the onCreate() method of the first activity. If
...
class Eula {
    ...
    static boolean show(final Activity activity) {
        final SharedPreferences preferences = activity.getSharedPreferences(Eula.PREFERENCES_EULA, Context.MODE_PRIVATE);
    ...
    private static void accept(final SharedPreferences preferences) {
        preferences.edit().putBoolean(Eula.PREFERENCE_EULA_ACCEPTED, true).commit();
    }
    ...
    private static CharSequence readEula(final Activity activity) {
        ...
        try {
            in = new BufferedReader(new InputStreamReader(activity.getAssets().open(Eula.ASSET_EULA)));
            String line;
