...
public class OutcomeAdd extends Activity {
    ...
    protected Dialog onCreateDialog(final int id) {
        switch (id) {
            case DIALOG_DATE_ID:
                final DatePickerDialog.OnDateSetListener listener = new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(final DatePicker view, final int year, final int month, final int day) {
                        ...
                        OutcomeAdd.this.date = c.getTime();
                        updateDateDisplay();
                    }
                };
                final Calendar c = Calendar.getInstance();
            ...
            case DIALOG_LABELS_ID:
                ...
                b.setMultiChoiceItems(getLabels(), null, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, final int which, final boolean isChecked) {
                        if (isChecked) {
                            OutcomeAdd.this.checked.add(labels.get(which));
                        } else {
                            OutcomeAdd.this.checked.remove(labels.get(which));
                        }
                    }
                });
            ...
            case DIALOG_VALUE_ID:
                    ...
                    public void onClick(final DialogInterface dialog, final int id) {
                        ...
                        try {
                            ...
                            if (val > Expense.MAX_VAL) {
                                Toast.makeText(OutcomeAdd.this, getString(R.string.outcome_add_msg_err_value_to_high, Expense.MAX_VAL),
                                        Toast.LENGTH_LONG).show();
                                return;
                            }
                            OutcomeAdd.this.value = val;
                            updateMoneyDisplay();
                        } catch (final ParseException e) {
                            Toast.makeText(OutcomeAdd.this, getString(R.string.outcome_add_msg_err_invalid_value, value),
                ...
                builder.setView(LayoutInflater.from(this).inflate(R.layout.outcome_add_value, null))
                        .setTitle(getString(R.string.outcome_add_value_header)).setCancelable(false)
                        .setPositiveButton(getString(R.string.outcome_add_btn_set), positiveBtn)
                        .setNegativeButton(getString(R.string.outcome_add_btn_cancel), negativeBtn);
    ...
    private void initBtnDate() {
        this.date = new Date();
        final Button btn = (Button) findViewById(R.id.outcome_add_btn_date);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                showDialog(OutcomeAdd.DIALOG_DATE_ID);
            }
        });
        updateDateDisplay();
    }
    ...
    private void initBtnMoney() {
        this.value = 0;
        final Button btn = (Button) findViewById(R.id.outcome_add_btn_value);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                showDialog(OutcomeAdd.DIALOG_VALUE_ID);
            }
        });
        updateMoneyDisplay();
    }
    ...
    private void initLayout() {
        setContentView(R.layout.outcome_add);
        final Button btnCancel = (Button) findViewById(R.id.outcome_add_btn_cancel);
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                OutcomeAdd.this.finish();
            }
        });
        final Button btnAdd = (Button) findViewById(R.id.outcome_add_btn_add);
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                final EditText text = (EditText) findViewById(R.id.outcome_add_descr);
                final String descr = text.getText().toString();
                final Expense expense = new Expense(ExpenseMode.OUTCOME, OutcomeAdd.this.date, OutcomeAdd.this.value, descr);
                for (final Label label : OutcomeAdd.this.checked) {
                    expense.addLabel(label);
                }
                try {
                    expense.persist(OutcomeAdd.this);
                    Toast.makeText(OutcomeAdd.this, getString(R.string.outcome_add_msg_outcome_added), Toast.LENGTH_SHORT).show();
                } catch (final EntityAlreadyExistsException e) {
                    Toast.makeText(OutcomeAdd.this, getString(R.string.outcome_add_msg_err_outcome), Toast.LENGTH_SHORT).show();
                }

                OutcomeAdd.this.finish();
            }
        });
        final Button btnLabels = (Button) findViewById(R.id.outcome_add_btn_labels);
        btnLabels.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                showDialog(OutcomeAdd.DIALOG_LABELS_ID);
            }
        });
        initBtnMoney();
        initBtnDate();
